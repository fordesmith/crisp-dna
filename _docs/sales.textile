...
The solution is _load balancing_ - having a group of trusted colleagues that you can send clients to and receive clients from. And that's exactly what Syncopate is - a bunch of trusted colleagues! 
...
h2. Does the business developer earn a provision?

No. The business developer is strictly speaking a contractor, but her only client is Syncopate and she charges a fixed fee per month. 
...
h2. Is the business developer an employee?

No, she is a contractor. We let people choose which model they want. Our default is to minimize the number of Syncopate employees (because it causes more admin overhead), so almost everyone at Syncopate is strictly speaking a subcontractor rather than an employee. But the "office team":office-team.html wanted a more traditional employee-employer setup, which is fine.

h2. What power does the business developer have?

No formal powers at all! Although, like with all Syncopaters, there's plenty of _informal power_ to go around :o)

In more typical consulting companies, sales people and business developers "own" their "resources" and can move and allocate them to clients as needed. At Syncopate, however, we have no managers; people are people (not resources) and are free to do whatever they want! Since the business developer can't force anyone to do anything, she needs to work in close collaboration with the consultants. Basically, check with Jim before offering him to a client!

This makes the job a bit more complex, but the returns are very high, because "motivated consultants do a _much_ better job":why-this-works.html.
