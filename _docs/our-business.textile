...
# *New product development, especially in Financial Services*. Either shorter or longer engagements.
# *Agile/Lean/Design Thinking coaching and training*. Mostly shorter engagements or part-time.
# *Large project or business set up and delivery (using agile etc)*. Mostly longer engagements and close to full-time.
