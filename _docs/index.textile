...
Sycopate is a consulting company based in Sydney, Australia. But we aren't a very typical consulting company. For example:
...
* Sycopate's main purpose is to enable consultants to be happy, and "Crisp Happiness Index":happiness-index.html is our driving metric. Strong revenue and delighted customers are a side effect, not a goal.
* Sycopate doesn't want to earn money from it's consultants. It is in practice a non-profit company (although not formally so). Consultants "keep most of what they earn":economic-model.html.
...
* Consultants are 100% autonomous. They can do whatever they want (as long as they don't hurt the brand or "our house":what-is-sycopate.html), and work as much or as little as they want.

We cloned the Crisp DNA. Want to start a similar org? See "How to clone the Crisp DNA":how-to-copy.html.

h2. Why did Crisp open-source their DNA?

* To make the world a better place! The model has helped them (and us) be happy and make a positive impact in the world, and publishing it may help others do the same.
...
(these principles drive almost everything at Sycopate)

* "What is Sycopate":what-is-sycopate.html - the purpose of the company
* "How Crisp works":how-sycopate-works.html - summary of our model, and some driving principles.
...
* "Contracts":contracts.html - our internal contracts for Sycopate membership, ownership, etc.
...
* "Brand building":brand-building.html - how do we build the brand, both Sycopate and personal brands?
