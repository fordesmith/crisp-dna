...
bq. We introduced this to Syncopate because we had just created a lightweight recruitment process, and later when we were creating a lightweight sales process we noticed many similarities. So we did an "extract to interface":http://sourcemaking.com/refactoring/extract-interface refactoring and created this "Muffin Protocol" :o)

h2. The metaphor

!../assets/Muffin.jpg(Sia's Home baked Kanelbulle! Yum!)!
...
h3. What if several people want the same muffin?
...
h3. But what if I accidentally throw away an important muffin!?
...
h3. Why not forbid people to throw away muffins?
...
h3. Won't a muffin get dry if it gets sent around between people for too long?
...
h3. How do we avoid muffins getting dropped between chairs
...
h3. What would be alternatives to the muffin protocol?
...
h3. What are the potential disadvantages of the muffin protocol?
